...
public class GitRepositoryHelper {
    ...
    public static CommitDescriptor getHeadCommitDescriptor(File baseDirectory) throws GitAPIException, IOException {
        return getHeadCommitDescriptor(baseDirectory, null);
    }

    public static CommitDescriptor getHeadCommitDescriptor(File baseDirectory, String branch) throws GitAPIException, IOException {
